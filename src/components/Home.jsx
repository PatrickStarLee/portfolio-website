  ...
  return (
    <div name="home" className="w-full h-screen bg-[#0a192f]">
      ...
      <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
        <p className="text-[#bae9c6]">Hi, my name is</p>
        ...
        <div>
          <Link to="work" smooth={true} duration={500} className="text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600 hover:cursor-pointer w-40">
            View Work
